...
const CartDropdown = () => {
  ...
  return (
    <div className="absolute w-72 h-80 flex flex-col p-5 border border-black bg-white z-10">
      ...
      <Link className="mt-4 ml-auto border border-green-400 p-1 rounded-sm" href='/checkout'>CHECKOUT</Link>
    </div>
  )
}
